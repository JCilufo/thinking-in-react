  ...
  return (
    <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-lg p-8 border-2 border-green-200">
      <ProductFilters
        ...
        onMaxPriceSliderChange={setMaxPriceSlider}
      ...
      <div className="flex items-center justify-between">
        ...
        {hasActiveFilters && (
          <button
            ...
            className="px-4 py-2 text-sm font-medium text-green-700 hover:text-green-900 hover:bg-green-100 rounded-lg transition-colors cursor-pointer"
          >
            Clear all filters
          </button>
        )}
